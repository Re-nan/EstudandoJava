 ...
 * 
 * Os enuns são tipos de dados assim como classes e os tipos primitivos, a diferença é que os enums
 * permitem restringirem variaveis a valores previamente determinados, portando as variáveis que são
 * do tipo de enums só podem assumir "aqueles valores X" que foram definidos em sua criação.
 * 
 * Enuns ajudam a reduzir bugs no código pois você pode atribuir á uma variavel do tipo enum aquele
 * valor determinado, são parecidos com váriáveis constantes, mas possuem estruturas e implementações
 * bem diferentes
 * 
 */
