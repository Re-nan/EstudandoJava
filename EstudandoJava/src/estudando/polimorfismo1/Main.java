...
/**
 * Referência = é o que ta na esquerda  Instancia = é o que ta na direita
 *
 ...
 * da direita, o tipo da varariável(tipo da referência) só enxerga o que ela tem em
...
public class Main {
	...
	public static void main(String[] args) {
		...
		/* por mais que faça o cast, continua chamando o método da instancia c
		 * de Cachorro.
		 */
	 ...
	 * diferente de acordo com o obj que está anteciado na memória. Quando você
